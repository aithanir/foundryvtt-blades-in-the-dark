...
export class BladesClockSheet extends BladesSheet {
  ...
  /** @override */
	static get defaultOptions() {
	  return foundry.utils.mergeObject(super.defaultOptions, {
  	  ...
  	  template: "systems/winter-of-discontent/templates/actors/clock-sheet.html",
      width: 420,
      height: 400,
    });
  }
  ...
  async _updateObject(event, formData) {
    let image_path = `systems/winter-of-discontent/styles/assets/progressclocks-svg/Progress Clock ${formData['system.type']}-${formData['system.value']}.svg`;
